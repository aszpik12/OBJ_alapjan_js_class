class Termek {
  ...
  constructor(ARTICLE, OBJ) {
    ...
    this.#kedvencButtonElem = this.#divElem.children(".card-footer").children(".kedvenc");
    this.#torolButtonElem = this.#divElem.children(".card-footer").children(".torol");
  ...
  esemenyTrigger(esemenyNev) {
    const esemeny = new CustomEvent("kedvencekhez", {
      detail: this.#adat.id,
    });
